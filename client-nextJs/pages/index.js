...
import SliderSection from "../layouts/components/Carousel";
...
export const getStaticProps = async () => {
  ...
  const homepagecarousel = await getListPage("content/carousel.md");
  ...
  return {
    props: {
      ...
      Carousels: homepagecarousel.frontmatter.Carousels,
    },
  };
};
